...
namespace WebPageEntityFrameworkMvc.Controllers
{
    public class SportsController : Controller
    {
        ...
        public SportsController(MagicContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome")] Sport sport)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome")] Sport sport)
        {
            if (id != sport.Id)
            {
                return NotFound();
